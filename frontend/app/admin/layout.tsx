                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="text-right hidden sm:block">
                                <p className="text-xs font-black text-admin-text-main leading-none mb-1 uppercase italic tracking-tighter">{user?.nom || 'Admin'}</p>
                                <p className="text-[8px] font-bold text-admin-text-dim uppercase tracking-[0.4em]">Auth Protocol 1.0</p>
                            </div>
                            <div className="w-10 h-10 rounded-xl bg-admin-inner border border-admin-border flex items-center justify-center font-black text-admin-accent shadow-inner group">
                                <span className="text-sm group-hover:scale-110 transition-transform">{user?.nom?.charAt(0) || 'A'}</span>
                            </div>
                        </div>
                    </div>
                </header>
